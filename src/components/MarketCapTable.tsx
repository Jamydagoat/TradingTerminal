...
export function MarketCapTable({ data, live }: { data: MarketCapRow[]; live: boolean }) {
  return (
    <Panel title="Market Cap Leaders" right={<StatusTag live={live} />}>
        ...
        <table className="w-full text-[13px]">
          <thead>
            <tr className="text-left text-[10px] uppercase tracking-[0.08em] text-faint">
              ...
              <th className="px-3 py-1.5 font-medium text-right">Mkt Cap</th>
